...
<body>
    <form action="@ViewBag.Action" method="post" enctype="multipart/form-data" id="EHS">
        ...
        <table>
            <tr>
                <td colspan="3"><h1>EHS No. @Model.ID<input id="ID" type="hidden" name="ID" value="@Model.ID"></h1></td>
            </tr>
            <tr>
                <td colspan="3">
                    <div class="inputPlusLabel">
                        <strong>Date</strong>
                        @Code
                            @<input type="date" name="EHSDate" placeholder="Date created" value="@DateTime.Parse(Model.Fields("EHSDate")).ToString("yyyy-MM-dd")" required>
                        End Code
                    </div>
                    <div class="inputPlusLabel">
                        <strong>Shift</strong>
                    ...
                    <div class="inputPlusLabel">
                        ...
                        <select name="Department" id="dept" onchange="getZonesAndWorkCells(getSelectText(this));" required></select>
                    </div>
                    <div class="inputPlusLabel">
                        <strong>Zone</strong>
            ...
            <tr>
                <td colspan="2">
                    <textarea maxlength="1000" name="Comments" rows="6" cols="50" form="EHS" placeholder="Comments.">@Model.Fields("Comments")</textarea><br />
                </td>
                <td>
    ...
    <script>
        ...
        //ensure correct URL
        var STR_NOT_FOUND = -1;
        if (location.href.indexOf("/EHS/Open", 0) == STR_NOT_FOUND) {
